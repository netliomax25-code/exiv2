...
constexpr TagDetails canonShutterMode[] = {
    {0, N_("Mechanical")}, {1, N_("Electronic First Curtain")}, {2, N_("Electronic")},
};
...
constexpr TagInfo CanonMakerNote::tagInfoFi_[] = {
    ...
    {0x0015, "FocusDistanceLower", N_("Focus Distance Lower"), N_("Focus Distance Lower"), IfdId::canonFiId,
     SectionId::makerTags, unsignedShort, 1, printFiFocusDistance},
    {0x0017, "ShutterMode", N_("Shutter Mode"), N_("Shutter mode"), IfdId::canonFiId, SectionId::makerTags,
     signedShort, 1, EXV_PRINT_TAG(canonShutterMode)},
